<template>
  <div class="header flex flex-wrap ">
    ...
    >
      ...
      <h2 class="lg:mx-16 sm:mx-8 lg:text-3xl sm:text-2xl text-orange-600 mt-6">
        What is ThyFlow?
      </h2>
      <p class="lg:mx-16 sm:mx-6  lg:text-lg md:text-md">
      ...
      <p class="lg:mx-16 sm:mx-4 lg:text-lg md:text-md">
