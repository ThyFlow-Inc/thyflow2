<template>
    ...
    <div class="container mx-auto px-8">
      <div class="w-full flex flex-col md:flex-row py-6">
        <div class="flex-1 mb-6">
          ...
          <div
            class="flex-1 mb-6 pr-6"
            id="sfb7f50c74b64bd37f23a6d7e9bd810c725845ab0f64ad2eba"
  ...
  /*** RESPONSIVE END */
              ...
              <div
                ...
                style="background-color:#ffffff;width: 350px;z-index:2;font-family:'Arial';border-width: 1px;border-style:solid; border-color:rgb(235, 235, 235);overflow: hidden;"
                name="SIGNUP_BODY"
              >
                <div>
                  <span
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div style="display:table-cell">
                          <span
                            id="signupSuccessMsg"
                            style="color: rgb(73, 140, 132);font-family: sans-serif;font-size: 14px;word-break:break-word;line-height: 30px;display: block;"
                          ></span>
                        </div>
                      </div>
                      <input
                        type="text"
                        style="font-size: 14px;border:1px solid rgb(235, 235, 235);border-radius: 0;width: 100%;height: 100%;z-index:4;outline:none;padding: 5px 10px;color:#888888;text-align:left;font-family:'Arial';background-color: transparent;background-color:#ffffff"
                        placeholder="Email"
                    ...
                    <div
                      style="position:relative;width: 90px;height: 30px;text-align: left;display: inline-block;margin: 0px 0px 10px;"
                    >
                      <input
                        type="submit"
                        style="text-align:center;width:100%;height:100%;z-index:5;border:0;color:#ffffff;cursor: pointer;outline:none;font-size: 14px;background-color: #ff7944;margin: 0;margin-left: -5px;border-radius: 0 3px 3px 0;"
        ...
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a
                href="https://www.facebook.com/thyflow"
                class="no-underline hover:underline text-gray-800 hover:text-orange-500"
              >Facebook</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a
                href="https://www.linkedin.com/in/thyflow"
                class="no-underline hover:underline text-gray-800 hover:text-orange-500"
              >Linkedin</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a
                href="https://www.twitter.com/thyflow"
                class="no-underline hover:underline text-gray-800 hover:text-orange-500"
              >Twitter</a>
            </li>
          </ul>
