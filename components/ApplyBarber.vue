<template>
  <div class="gradient">
    ...
    <section class="container mx-auto text-center py-8 px-24">
      ...
      <h6
        class="w-full my-2 text-4xl mx-12 font-bold leading-tight text-center text-white"
      >Imagine having your own personal barber with a snap of a finger, Now that's ThyFlow!</h6>
